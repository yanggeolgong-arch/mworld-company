...
1. 상단 **"메시지" 입력란**에 다음 커밋 메시지 입력:
   ```
   feat: 엠월드컴퍼니 엔티티 SEO 강제 실행 및 전수 한국어화
   
   - Entity SEO: 모든 메타데이터에 엠월드컴퍼니 브랜드명 맨 앞 배치
   - JSON-LD Organization 스키마에 카카오톡 SG7979 포함
   - 전수 한국어화: M-World Company → 엠월드컴퍼니
   - 협력 문의 → 협업 문의 통일
...
### 메타데이터 변경
- **레이아웃**: "엠월드컴퍼니 | 10년 차 전문가의 압도적 실행 전략"
- **성공 사례**: "엠월드컴퍼니 성공 사례 | 실행력으로 증명된 압도적 성과"
- **성장 엔진**: "엠월드컴퍼니 성장 엔진 | 효율성 극대화 AI 자동화 시스템"
- **성공 노하우**: "엠월드컴퍼니 성공 노하우 | 10년 차 전문가의 마케팅 인사이트"
- **협업 문의**: "엠월드컴퍼니 협업 문의 | 카카오톡 SG7979"
