...
/** 조사 기준: 다이닝코드 2025.3, 네이버 플레이스·구글 검색 참고 */
export const initialShops: Shop[] = [
  ...
  { id: 2, name: '섬타르', img: `${IMG_BASE}/2.avif`, rating: 3.9, reviewCount: 185, ratingSource: '다이닝코드 2025.3', brief: '제주 로컬 타르트', teaser: '구좌 당근, 우도 땅콩 타르트', story: '제주 원재료를 담은 달콤한 타르트 전문점입니다.', query: '제주 섬타르', address: '제주특별자치도 제주시 노형동 1280-1 (다랑곶1길 9)', phone: '064-744-4467', hours: '09:30 ~ 22:30', parking: '불가(인근 주차)', menuPrice: '에그타르트 4,500원~, 구좌당근타르트', carMinutesFromAirport: 10, busRoutesFromAirport: '100번, 200번 (노형·드림타워 인근)', mapX: 38, mapY: 28, youtubeUrl: 'https://www.youtube.com/shorts/e-94iwTxuDk', naverPlaceUrl: 'https://m.place.naver.com/place/list?query=제주+섬타르', googlePlaceUrl: 'https://www.google.com/maps/search/제주+섬타르', imgAlt: '제주 섬타르 구좌당근타르트 - 제주 노형동 카페 베스트', cuisine: '카페, 베이커리', postalCode: '63085', addressLocality: '제주시 노형동' },
  ...
  { id: 4, name: '커피구십구점구', img: `${IMG_BASE}/4.avif`, rating: 4.4, reviewCount: 392, ratingSource: '네이버 플레이스·구글 참고', brief: '바리스타의 철학', teaser: '99.9% 완벽한 커피', story: '직접 로스팅한 원두의 깊은 향미를 느껴보세요.', query: '제주 커피구십구점구', address: '제주특별자치도 제주시 한림읍 한림로 585', phone: '064-796-9099', hours: '10:00 ~ 19:00', parking: '가능', menuPrice: '아메리카노 5,000원~', carMinutesFromAirport: 42, busRoutesFromAirport: '202번 (한림 방면, 한림정류장 하차)', mapX: 14, mapY: 56, youtubeUrl: 'https://www.youtube.com/shorts/UdV2_-9_2iE', naverPlaceUrl: 'https://m.place.naver.com/place/list?query=제주+커피구십구점구', googlePlaceUrl: 'https://www.google.com/maps/search/제주+커피구십구점구', imgAlt: '제주 한림 커피구십구점구 로스팅 커피 - 제주도 카페', cuisine: '카페', postalCode: '63046', addressLocality: '제주시 한림읍' },
  { id: 5, name: '돈이랑', img: `${IMG_BASE}/5.avif`, rating: 4.4, reviewCount: 468, ratingSource: '다이닝코드·네이버 플레이스 참고', brief: '흑돼지 전문', teaser: '제주 흑돼지의 정석', story: '숯불에 구운 흑돼지의 육즙을 만나보세요.', query: '돈이랑 일주서로', address: '제주특별자치도 서귀포시 일주서로 953 1층', phone: '0507-1435-9278', hours: '11:30 ~ 24:00', parking: '가능', menuPrice: '흑돼지 1인분 15,000원~', carMinutesFromAirport: 48, busRoutesFromAirport: '600번 공항리무진 (중문 터미널 하차 후 차로 5분)', mapX: 52, mapY: 88, youtubeUrl: 'https://www.youtube.com/shorts/NNiF2xzWorg', naverPlaceUrl: 'https://m.place.naver.com/place/list?query=돈이랑+일주서로+953', googlePlaceUrl: 'https://www.google.com/maps/search/돈이랑+일주서로+953', imgAlt: '서귀포 돈이랑 제주 흑돼지 구이 - 중문 맛집', cuisine: '한식, 고기', postalCode: '63572', addressLocality: '서귀포시 중문' },
