          ...
          >
            ...
            >
              ...
              <div className="p-5 overflow-y-auto text-[12px] text-slate-600 leading-relaxed space-y-4 max-h-[70vh]">
                ...
                {legalModal === 'terms' && (
                  <div className="space-y-4">
                    <p>정보의 성격: 본 사이트에서 제공하는 &apos;제주 베스트&apos; 및 관련 정보는 연구소의 독자적인 AI 데이터 분석 결과이며, AI와 함께 제작된 정보성 콘텐츠입니다.</p>
                    <p>책임 제한: 연구소는 정보의 정확성을 위해 최선을 다하나, 매장의 실제 영업 상태나 변동 사항에 대해 법적 책임을 지지 않습니다. 방문 전 반드시 해당 매장에 최종 확인을 권장합니다.</p>
                    <p>지식재산권: 본 사이트의 디자인, 로직, 데이터 구성 방식은 연구소의 자산이며 무단 복제 및 상업적 재배포를 금합니다.</p>
                  </div>
                )}
                {legalModal === 'about' && (
